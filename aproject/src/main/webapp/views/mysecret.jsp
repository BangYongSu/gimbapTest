...
<div class ="mtm">
 ...
 <div class = "dist2"></div>
   ...
   <p>${cus.cus_name}님의 정보</p>
    <div class="mb-3">
      <label >비밀번호</label>
      <div class="dist1"></div>
      <input type="password" class="form-control" id="cus_ps" value="${cus.cus_ps}" name="cus_ps">
    </div>
    <div class="mb-3">
      <label >카드번호</label>
      <div class="dist1"></div>
      <input type="text" class="form-control" id="card_no" value="${cus.card_no}" name="card_no"pattern="[0-9]{16}">
    </div>
    <div class="mb-3">
      <label >생년월일</label>
      <div class="dist1"></div>
      <input type="date" class="form-control" id="cus_bd" value="${cus.cus_bd	}" name="cus_bd">
    </div>
  	<div class="btn">
    <button type="submit" class="btn btn-primary" id= "btnb" name="btnb">수정완료</button>
